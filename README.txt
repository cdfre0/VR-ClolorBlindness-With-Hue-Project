...
Goal of Application: I have implemented "Farnsworth Munsell 100 Hue Test", which helps user to detect if they suffer from color blindness. One is meant to put each cake in a box, so that color of them would smoothly  change from left to right. Submit set by pressing the button. There are 4 sets of cakes with different color, after each set button needs to be clicked. After all sets, result will be displayed.
